...
type TypographyVariant = "h1" | "h2" | "h3" | "h4" | "h5" | "body" | "button" | "badge" | "caption" | "span"
...
const variantStyles: Record<TypographyVariant, string> = {
  ...
  badge: "text-xs md:text-sm px-3 sm:px-4 py-1.5 sm:py-2 rounded-full tracking-wider",
  caption: "text-xs",
}
...
export const Typography: React.FC<TypographyProps> = ({
  ...
  const combinedClassName = twMerge(baseStyles, colorStyle, alignStyle, maxWidthStyle, noWrapStyle, bgStyle, className)
